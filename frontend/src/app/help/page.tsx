...
export default function HelpPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "In the rare event of a no-show, you can cancel the request and choose another available professional or submit a support request.",
    },
    {
    ...
    },
    {
      ...
      a: "Professionals who complete the required verification process display a verified badge on their profile.",
    },
  ];
      ...
      <div className="flex-1 pt-8 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            <Link
              href="/support"
              className="rounded-2xl border border-border bg-card p-6 text-center hover:border-primary/50 hover:shadow-md transition-all block cursor-pointer min-h-[44px]"
            >
              ...
              <p className="text-sm text-muted-foreground">
                Submit a support request about your account or booking.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Share your experience, report an issue, or suggest a feature.
              </p>
            </Link>
          </div>
            ...
            <div className="grid gap-4 max-w-3xl mx-auto">
              ...
              {filteredFaqs.length === 0 && (
                <p className="text-center text-muted-foreground py-8">
                  No help articles found matching &ldquo;{search}&rdquo;.
                </p>
              )}
            </div>
          </div>
